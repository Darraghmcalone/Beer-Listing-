...
*/
var Beer = function () {
    function Beer(name, description, tagline, imageUrl, abv, ibu, ph) {
    ...
    _createClass(Beer, [{
        ...
        value: function addToPage() {
            ...
            var box = document.querySelector('.beer-box');
            ...
            var ABVlabel = document.createElement('h1');
            ABVlabel.innerText = "ABV";

            var abvElement = document.createElement('h1');
            abvElement.innerText = this.abv;

            var IBUlabel = document.createElement('h1');
            IBUlabel.innerText = "IBU";

            var ibuElement = document.createElement('h1');
            ibuElement.innerText = this.ibu;

            var phlabel = document.createElement('h1');
            phlabel.innerText = "pH";

            var phElement = document.createElement('h1');
...
var Pickabeer = function Pickabeer() {
  _classCallCheck(this, Pickabeer);
};

exports.default = Pickabeer;
...
var _Pickabeer = require('./Pickabeer');

var _Pickabeer2 = _interopRequireDefault(_Pickabeer);
...
},{"./Beer":28,"./Pickabeer":29,"axios":1}]},{},[30]);
